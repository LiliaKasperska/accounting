        ...
        <div class="row" style="height: 100%;">
            ...
            <div class="col-sm-2 " style=" background-color: #b1c840;">
                <div class="btn-group-vertical nav justify-content-end" role="group" aria-label="Basic example">
                    <a href="cars_list.php"><button type="button" class="btn2 btn-dark2" autofocus>Список автомобілів</button></a>
                    <div style="height: 15px;"></div>
                    <a href="car_new.php"><button type="button" class="btn2 btn-dark2">Додати автомобіль</button></a>
                </div>
            </div>
            <div class="col-sm-6">    
            <div style="height: 5%;"></div>                 
                <?php
                    ...
                    while($result=mysqli_fetch_array($res)){
                        ?>
                        <form method="POST" action="cars_list.php">
                            <div class="input-group col-sm-8">
                                <input type="text" class="form-control" aria-label="Recipient's username with two button addons" aria-describedby="button-addon4" readonly value="<?php echo $result['brand']; ?> (<?php echo $result['m_number']; ?>), <?php echo $result['max_weight_cargo'] ?> тонн">
                        ...
                        if(isset($_POST['delete'])){
                            $sql="DELETE FROM cars WHERE id='".$_POST['delete']."'";
                            $res=mysqli_query($connect,$sql);
                            ?>
                        ...
                        if(isset($_POST['change'])){
                            $_SESSION['id_c']=$_POST['change'];
                            ?>
                            <script>document.location.href="car_new.php"</script>
                            <?php
                        }
                    }
                ?>
