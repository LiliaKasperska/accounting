        ...
        <div class="row" style="height: 100%;">
            ...
            <div class="col-sm-2 " style=" background-color: #b1c840;">
                <div class="btn-group-vertical nav justify-content-end" role="group" aria-label="Basic example">
                    ...
                    <a href="d_transporting_my.php"><button type="button" class="btn2 btn-dark2" autofocus>Мої перевезення</button></a>
                    <div style="height: 15px;"></div>
            ...
            <div style="height: 5%;"></div>
                <?php
                    $sql="SELECT * FROM transportation WHERE id_status<>'3' AND id_driver='".$_SESSION['id']."' ORDER BY id_status ASC";
                    $res=mysqli_query($connect,$sql);
                ?>
                <form method="POST" action="d_transporting_my.php">
                    <?php
                    while($result=mysqli_fetch_array($res)){
                    ?>                        
                        <div class="input-group col-sm-11">
                            <input type="text" class="form-control" aria-label="Recipient's username with two button addons" aria-describedby="button-addon4" readonly value="<?php echo $result['name'].", ".$result['date_start']." - ".$result['date_finish'].", "; foreach($status as $id => $name){if($result['id_status']==$id){echo $name;}} ?>">
