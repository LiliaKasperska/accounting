        ...
        <div class="row" style="height: 100%;">
            ...
            <div class="col-sm-2 " style=" background-color: #b1c840;">
                <div class="btn-group-vertical nav justify-content-end" role="group" aria-label="Basic example">
                    <a href="transporting_main.php"><button type="button" class="btn2 btn-dark2" autofocus>Список перевезень</button></a>
            ...
            <div class="col-sm-6">   
                ...
                <?php
                    if(isset($_POST['all'])){
                        $sql="SELECT * FROM transportation WHERE id_status='2' ORDER BY id DESC";
                        $res=mysqli_query($connect,$sql);
                    } else if(isset($_POST['with_d'])){
                        $sql="SELECT * FROM transportation WHERE id_status='2' AND id_driver<>'1' ORDER BY id DESC";
                        $res=mysqli_query($connect,$sql);
                    } else if(isset($_POST['without_d'])){
                        $sql="SELECT * FROM transportation WHERE id_status='2' AND id_driver='1' ORDER BY id DESC";
                        $res=mysqli_query($connect,$sql);
                    } else {
                        $sql="SELECT * FROM transportation WHERE id_status='2' ORDER BY id DESC";
                ...
                ?>
                <form method="POST" action="transporting_main.php">
                    <?php
                    while($result=mysqli_fetch_array($res)){
                    ?>                        
            ...
            <div class="col-sm-2 ">
                ...
                <div class="btn-group-vertical nav justify-content-end " role="group" aria-label="Basic example">
                    <form method="POST" action="transporting_main.php">
                        <button type="submit" class="btn3 btn3-dark3"  name="all">Всі</button>
                        <div style="height: 15px;"></div>
                        <button type="submit" class="btn3 btn3-dark3"  name="with_d">З водієм</button>
                        <div style="height: 15px;"></div>
                        <button type="submit" class="btn3 btn3-dark3"  name="without_d">Без водія</button>
                    </form>
                </div>
                </div>
            </div>
